...
public class TabOneAdapter extends RecyclerView.Adapter<TabOneAdapter.MyViewHolder> {
    private List<Article> mList=new ArrayList<>();
    private Context mContext;
    private final RecyclerView mRecyclerView;

    public TabOneAdapter(Context context, List<Article> mList,RecyclerView mRecyclerView) {

...
public class TabThreeAdapter extends RecyclerView.Adapter<TabThreeAdapter.MyViewHolder> {

    private List<Article> mList=new ArrayList<>();
    private Context mContext;
    private final RecyclerView mRecyclerView;

    public TabThreeAdapter(Context context, List<Article> mList,RecyclerView mRecyclerView) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new TabThreeAdapter.MyViewHolder(v);
    }
